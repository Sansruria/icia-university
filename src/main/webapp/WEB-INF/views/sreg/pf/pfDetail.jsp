							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3">
										...
										<span class="w-75 border p-3"><c:out value="${pfDto.deptName}"></c:out></span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3">
										...
										<span class="w-75 border p-3"><c:out value="${pfDto.pfId}"></c:out></span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3">
										...
										<span class="w-75 border p-3"><c:out value="${pfDto.name}"></c:out></span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3">
										...
										<span class="w-75 border p-3"><c:out value="${pfDto.rrn}"></c:out></span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3">
										...
										<span class="w-75 border p-3"><c:out value="${pfDto.address}"></c:out></span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3">
										...
										<span class="w-75 border p-3"><c:out value="${pfDto.email}"></c:out></span>
									</div>
								</div>
							</div>
